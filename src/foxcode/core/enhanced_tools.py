"""
FoxCode 增强工具模块 - 集成核心模块的工具封装

这个文件将核心模块的功能封装为工具函数，供 AI 代理调用:
1. 语义搜索：基于自然语言搜索代码
2. 代码格式化：自动格式化代码
3. 文档生成：自动生成文档
4. 依赖分析：解析项目依赖
...
使用方式:
    from foxcode.core.enhanced_tools import search_semantic

    results = await search_semantic("查找用户登录相关代码")
"""
